...
# ENV dan o'qish
TOKEN = os.getenv("8747859987:AAHzmluAgIquFLZpjcFgEiwhIaMGSy3usRs")  # Telegram bot token
ADMIN_ID = int(os.getenv("8140857589", "0"))  # Telegram IDingiz
